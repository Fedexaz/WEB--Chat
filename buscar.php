		...
		<body>
			<div class="nav-menu">
				<ul>
					...
					<li><a class="active" href="buscar.php"><i class="material-icons" style="font-size: 26px;">search</i><span>Buscar </span><span class="badge badge-pill badge-warning">soon!</span></a></li>
					<?php 
