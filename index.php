		...
		<body>
			<div class="nav-menu">
				<ul>
					...
					<li><a class="active" href="index.php"><i class="material-icons" style="font-size: 26px;">home</i><span>Inicio </span><span class="badge badge-pill badge-warning">soon!</span></a></li>
