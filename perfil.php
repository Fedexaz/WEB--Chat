		...
		<body>
			<div class="nav-menu">
				<ul>
					...
					<li><a class="active" href="perfil.php"><i class="material-icons" style="font-size: 26px;">perm_identity</i><span>Perfil </span><span class="badge badge-pill badge-warning">soon!</span></a></li>
				...
				<div style="margin-left:16%;padding:1px 16px;height:auto;">
					<h2>Próximamente...</h2>
					<a class="btn btn-primary" href="mensajes.php">Ir a mensajes</a>
					<a class="btn btn-primary" href="chatglobal.php">Ir a chat global</a>
				</div>
			</div>
